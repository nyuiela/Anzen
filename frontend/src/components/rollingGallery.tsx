...
const RollingGallery: React.FC<RollingGalleryProps> = ({
   ...
   return (
      <div className="relative h-[100vh] w-full lg:w-[60vw] overflow-hidden">
         {/* <div
               ...
               {galleryImages.map((url, i) => (
                  ...
                  >
                     <Image
                        ...
                        width={100}
                        height={100}
                        className="pointer-events-none h-[220px] w-[400px] rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-105 sm:h-[200px] sm:w-[300px] lg:w-[50vw] lg:h-[10vh]"
                     />
                  </div>
               ))}
            </motion.div>
