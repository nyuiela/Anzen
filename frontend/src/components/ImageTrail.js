...
class ImageTrailVariant1 {
  constructor(container) {
    ...
    container.addEventListener("mouseover", handlePointerMove);
    ...
    const initRender = (ev) => {
      ...
      // container.removeEventListener("", initRender);
      container.removeEventListener("touchmove", initRender);
    };
    container.addEventListener("mouseover", initRender);
